...
from GilbertAnimeBot.modules.helper_funcs.decorators import gilinline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on Gilbert",
            "description": "Look up a Telegram account in Gilbert database",
            "message_text": "Click the button below to look up a person in Gilbert database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Gilbert",
            "message_text": "Click the button below to get to know about Gilbert.",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Gilbert (@{context.bot.username})
    Maintained by [AASFCYBERKING](t.me/AASFCYBERKING)
    Built with 🖤 using python-telegram-bot v{str(__version__)}
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/PigasusUpdates",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitLab",
                    url=f"https://www.gitlab.com/AASFCYBERKING/GilbertAnimeBot",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/AASFCYBERKING/GilbertAnimeBot",
                ),
            ],
        ])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Gilbert (@{context.bot.username})",
