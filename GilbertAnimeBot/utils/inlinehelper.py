...
from GilbertAnimeBot import OWNER_ID, pbot, arq
from GilbertAnimeBot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from GilbertAnimeBot.utils.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[Gilbert 🖤](https://github.com/AASFCYBERKING/GilbertAnimeBot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
